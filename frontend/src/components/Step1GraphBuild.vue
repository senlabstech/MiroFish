    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 0, 'completed': currentPhase > 0 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">{{ t('step1.ontology_generation') }}</span>
          </div>
        ...
        <div class="card-content">
          <p class="api-note">{{ t('step1.ontology_api') }}</p>
          <p class="description">
            {{ t('step1.ontology_desc') }}
          </p>
          ...
          <div v-if="selectedOntologyItem" class="ontology-detail-overlay">
            <div class="detail-header">
               <div class="detail-title-group">
                  <span class="detail-type-badge">{{ selectedOntologyItem.itemType === 'entity' ? t('step1.entity_type') : t('step1.relation_type') }}</span>
          ...
          <div v-if="projectData?.ontology?.entity_types" class="tags-container" :class="{ 'dimmed': selectedOntologyItem }">
            <span class="tag-label">{{ t('step1.generated_entities') }}</span>
            <div class="tags-list">
              <span
          ...
          <div v-if="projectData?.ontology?.edge_types" class="tags-container" :class="{ 'dimmed': selectedOntologyItem }">
            <span class="tag-label">{{ t('step1.generated_relations') }}</span>
            <div class="tags-list">
              <span
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Automatically chunks documents based on the generated ontology, calls Zep to build a knowledge graph, extracts entities and relationships, and forms temporal memory with community summaries
          </p>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 2, 'completed': currentPhase >= 2 }">
        ...
        <div class="card-content">
          ...
          <p class="description">Graph build complete. Proceed to the next step for environment setup.</p>
          <button
            class="action-btn"
