<template>
  ...
  >
    ...
    <div class="section-header">
      ...
      <span class="section-title">{{ t('history.section_title') }}</span>
      <div class="section-line"></div>
    </div>
        ...
        <div class="card-header">
          ...
          <div class="card-status-icons">
            <span
              ...
              :title="t('history.graph_build')"
            >◇</span>
            <span
              class="status-icon available"
              :title="t('history.env_setup')"
            >◈</span>
            <span
              class="status-icon"
              :class="{ available: project.report_id, unavailable: !project.report_id }"
              :title="t('history.analysis_report')"
            >◆</span>
          </div>
        </div>
        ...
        <div class="card-files-wrapper">
          ...
          <div class="files-list" v-if="project.files && project.files.length > 0">
            ...
            <div v-if="project.files.length > 3" class="files-more">
              {{ t('history.files_more', { count: project.files.length - 3 }) }}
            </div>
          </div>
          <!-- 无文件时的占位 -->
          <div class="files-empty" v-else>
            <span class="empty-file-icon">◇</span>
            <span class="empty-file-text">{{ t('history.no_files') }}</span>
          </div>
        </div>
        ...
        <div v-if="selectedProject" class="modal-overlay" @click.self="closeModal">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <!-- 文件列表 -->
              <div class="modal-section">
                <div class="modal-label">{{ t('home.upload_label') }}</div>
                ...
                <div class="modal-empty" v-else>{{ t('history.no_files') }}</div>
              </div>
            </div>
            ...
            <div class="modal-divider">
              ...
              <span class="divider-text">{{ t('home.workflow_header') }}</span>
              <span class="divider-line"></span>
            </div>
            ...
            <div class="modal-actions">
              ...
              >
                ...
                <span class="btn-text">{{ t('step.1_title') }}</span>
              </button>
              <button
              ...
              >
                ...
                <span class="btn-icon">◈</span>
                <span class="btn-text">{{ t('step.2_title') }}</span>
              </button>
              <button
              ...
              >
                ...
                <span class="btn-icon">◆</span>
                <span class="btn-text">{{ t('step.4_title') }}</span>
              </button>
            </div>
            <!-- 不可回放提示 -->
            <div class="modal-playback-hint">
              <span class="hint-text">Step3「{{ t('step.3_title') }}」与 Step5「{{ t('step.5_title') }}」需在运行中启动，不支持历史回放</span>
            </div>
          </div>
        </div>
      </Transition>
...
const formatRounds = (simulation) => {
  const current = simulation.current_round || 0
  const total = simulation.total_rounds || 0
  if (total === 0) return t('common.loading')
  return t('history.rounds', { current, total })
}
